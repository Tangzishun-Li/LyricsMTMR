...
ANCHORS = [
    ...
    {"id": "IP-327", "cat": "iteration-plan 引用", "level": "record",
     ...
     "note": "目录树总览扩容后 CI 条目移至 :51-58；round52-C 曾登记 2 行入 mindmap 区致 +2（:56），R52 收口归位目录树总览区后恢复 :54（第 52 轮收口修正）"},
    ...
    {"id": "IP-375", "cat": "iteration-plan 引用", "level": "record",
     ...
     "note": "signing-check.yml 树条目现位于 :58（ITER-20 修正后注释；round52-C 曾登记 2 行入 mindmap 区致 +2（:60），R52 收口归位目录树总览区后恢复 :58，第 52 轮收口修正）"},
