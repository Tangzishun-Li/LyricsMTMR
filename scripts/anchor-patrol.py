...
ANCHORS = [
    ...
    {"id": "REG-2", "cat": "注册点", "level": "live",
     "doc": "ITEMS_REFERENCE.md:1701", "desc": "decode switch 分支段 :955-1353（第 33 轮 A 卡第四批迁移 +85 行后更新）",
     "file": "LyricsMTMR/MTMR/Core/ItemsParsing.swift", "kind": "range", "start": 955, "end": 1353,
     "pattern": "switch type"},
