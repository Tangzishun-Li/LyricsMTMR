...
ANCHORS = [
    ...
    {"id": "REG-2", "cat": "注册点", "level": "live",
     "doc": "ITEMS_REFERENCE.md:1701", "desc": "decode switch 分支段 :763-1161（第 31 轮 A 卡批量迁移 +120 行后更新）",
     "file": "LyricsMTMR/MTMR/Core/ItemsParsing.swift", "kind": "range", "start": 763, "end": 1161,
     "pattern": "switch type"},
