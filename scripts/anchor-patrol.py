...
ANCHORS = [
    ...
    {"id": "REG-2", "cat": "注册点", "level": "live",
     "doc": "ITEMS_REFERENCE.md:1701", "desc": "decode switch 分支段 :870-1268（第 32 轮 A 卡第三批迁移 +107 行后更新）",
     "file": "LyricsMTMR/MTMR/Core/ItemsParsing.swift", "kind": "range", "start": 870, "end": 1268,
     "pattern": "switch type"},
