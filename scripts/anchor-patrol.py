...
ANCHORS = [
    ...
    {"id": "IP-327", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "verify_sparkle_key.sh", "known": 56,
     "note": "目录树总览扩容后 CI 条目移至 :51-58；round52-C 报告登记 2 行插入致再移位 +2 → :56（第 52 轮 C 卡修正）"},
    ...
    {"id": "IP-375", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "ITER-20 收敛", "known": 60,
     "note": "signing-check.yml 树条目现位于 :60（ITER-20 修正后注释；round52-C 报告登记 2 行插入致再移位 +2 → :60，第 52 轮 C 卡修正）"},
