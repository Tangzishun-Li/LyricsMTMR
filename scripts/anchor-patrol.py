...
ANCHORS = [
    ...
    {"id": "TOD-1", "cat": "ITER-14 待办", "level": "live",
     "doc": "docs/iteration-plan.md:9", "desc": "待办区引用「StockBarItem.swift:409 起」在位",
     "file": "docs/iteration-plan.md", "kind": "line", "line": 9,
     "pattern": "StockBarItem.swift:409"},
    {"id": "TOD-2", "cat": "ITER-14 待办", "level": "live",
     "doc": "docs/iteration-plan.md:9", "desc": "StockBarItem.swift:409 = 2027 预估段注释行",
    ...
    {"id": "MNT-1", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:16", "desc": "maintenance-notes 引用「StockBarItem.swift:390-391」在位",
     "file": "docs/maintenance-notes.md", "kind": "line", "line": 16,
     "pattern": "StockBarItem.swift:390-391"},
    {"id": "MNT-2", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:16", "desc": "StockBarItem.swift:390-391 = 2026 文号+URL 来源注释",
     "file": "LyricsMTMR/MTMR/Widgets/Life/StockBarItem.swift", "kind": "range", "start": 390, "end": 391,
     "pattern": "国办发明电〔2025〕7 号"},
    {"id": "MNT-3", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:18", "desc": "maintenance-notes 引用「aShareHolidays :396-420」在位",
     "file": "docs/maintenance-notes.md", "kind": "line", "line": 18,
     "pattern": ":396-420"},
    {"id": "MNT-4", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:18", "desc": "StockBarItem.swift:396 = static let aShareHolidays 起",
     "file": "LyricsMTMR/MTMR/Widgets/Life/StockBarItem.swift", "kind": "line", "line": 396,
     "pattern": "static let aShareHolidays"},
    {"id": "MNT-5", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:18", "desc": "StockBarItem.swift:420 = aShareHolidays 收（]）",
     "file": "LyricsMTMR/MTMR/Widgets/Life/StockBarItem.swift", "kind": "line", "line": 420,
     "pattern": r"^\s*\]\s*$", "regex": True},
    {"id": "MNT-6", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:19", "desc": "maintenance-notes 引用「aShareMakeupDates :425-440」在位",
     "file": "docs/maintenance-notes.md", "kind": "line", "line": 19,
     "pattern": ":425-440"},
    {"id": "MNT-7", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:19", "desc": "StockBarItem.swift:425 = static let aShareMakeupDates 起",
     "file": "LyricsMTMR/MTMR/Widgets/Life/StockBarItem.swift", "kind": "line", "line": 425,
     "pattern": "static let aShareMakeupDates"},
    {"id": "MNT-8", "cat": "maintenance-notes", "level": "live",
     "doc": "docs/maintenance-notes.md:19", "desc": "StockBarItem.swift:440 = aShareMakeupDates 收（]）",
     "file": "LyricsMTMR/MTMR/Widgets/Life/StockBarItem.swift", "kind": "line", "line": 440,
     "pattern": r"^\s*\]\s*$", "regex": True},
    ...
    {"id": "IP-148b", "cat": "iteration-plan 引用", "level": "record",
     ...
     "file": "LyricsMTMR/MTMR/App/AppDelegate.swift", "kind": "line", "line": 82,
     "pattern": "applicationDidReceiveMemoryWarning",
     "note": "round51-A 桌面歌词窗口接线合入 +8 → :82"},
    {"id": "IP-149a", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "if !snapshotDue", "known": 262,
     "note": "FIX-1/OPT-17 同步逻辑重写后移位（+21）；R57-W3 h 卡事件驱动刷新再重写 → :262（第 58 轮收口修正）"},
    {"id": "IP-149b", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "liveIdentifiers.insert", "known": 247,
     "note": "同步逻辑重写后插入点移位（+20）；R57-W3 h 卡事件驱动刷新重写 → :247（第 58 轮收口修正）"},
    ...
    {"id": "IP-158", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "aShareHolidays", "known": 396,
     "note": "ITER-7/8 外置数据源后表移至 :378；round44-A 合入 +16（数据获取单飞守卫与显式超时）→ :396（记录当时现状）"},
    {"id": "IP-169", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "snapshotRefreshInterval", "known": 71,
     "note": "ITER-9 落地自适应节流后逻辑移至 :22-27（记录当时现状）；R57-W3 h 卡改为按快照数分档静态函数 → :71（第 58 轮收口修正）"},
    ...
    {"id": "IP-202a", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "ItemFingerprint", "known": 372,
     "note": "枚举定义移位至 :226；R57-W3 h 卡重写后枚举移至 :372（第 58 轮收口修正）"},
    {"id": "IP-202b", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "func fingerprint(of", "known": 434,
     "note": "函数移位至 :288（文档注释现位于 :287，见 IP-204）；R57-W3 h 卡重写后 → :434，文档注释 :433（第 58 轮收口修正）"},
    ...
    {"id": "IP-281", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "2027（节日日期确定", "known": 409,
     "note": "round19-A 合入 +3 漂移（第 20 轮修正待办区引用，本条为当时验证记录）；round44-A 合入 +16 → :409"},
    ...
    {"id": "IP-327", "cat": "iteration-plan 引用", "level": "record",
     ...
     "file": "LyricsMTMR/docs/file-structure.zh.md", "kind": "range", "start": 55, "end": 55,
     "pattern": "verify_sparkle_key.sh", "known": 54,
     "note": "目录树总览扩容后 CI 条目移至 :55；round52-C 曾登记 2 行入 mindmap 区致 +2，R52 收口归位目录树总览区后恢复 :54，第 54 轮 B 卡 README 条目插入后 +1 → :55（第 54 轮收口修正）；R57-W3 j 卡 archive 段摘除后 → :54（第 58 轮收口修正）"},
    ...
    {"id": "IP-375", "cat": "iteration-plan 引用", "level": "record",
     ...
     "file": "LyricsMTMR/docs/file-structure.zh.md", "kind": "line", "line": 59,
     "pattern": "ITER-20 收敛", "known": 58,
     "note": "signing-check.yml 树条目现位于 :59（ITER-20 修正后注释；round52-C 曾登记 2 行入 mindmap 区致 +2（:60），R52 收口归位目录树总览区后恢复 :58，第 54 轮 B 卡 README 条目插入后 +1 → :59，第 54 轮收口修正）；R57-W3 j 卡 archive 段摘除后 → :58（第 58 轮收口修正）"},
