...
ANCHORS = [
    ...
    {"id": "IP-327", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "verify_sparkle_key.sh", "known": 55,
     "note": "目录树总览扩容后 CI 条目移至 :55；round52-C 曾登记 2 行入 mindmap 区致 +2，R52 收口归位目录树总览区后恢复 :54，第 54 轮 B 卡 README 条目插入后 +1 → :55（第 54 轮收口修正）"},
    ...
    {"id": "IP-375", "cat": "iteration-plan 引用", "level": "record",
     ...
     "pattern": "ITER-20 收敛", "known": 59,
     "note": "signing-check.yml 树条目现位于 :59（ITER-20 修正后注释；round52-C 曾登记 2 行入 mindmap 区致 +2（:60），R52 收口归位目录树总览区后恢复 :58，第 54 轮 B 卡 README 条目插入后 +1 → :59，第 54 轮收口修正）"},
