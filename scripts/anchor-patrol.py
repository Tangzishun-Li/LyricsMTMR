...
ANCHORS = [
    ...
    {"id": "REG-2", "cat": "注册点", "level": "live",
     "doc": "ITEMS_REFERENCE.md:1701", "desc": "decode switch 分支段 :1043-1441（第 34 轮 A 卡第五批迁移 +88 行后更新）",
     "file": "LyricsMTMR/MTMR/Core/ItemsParsing.swift", "kind": "range", "start": 1043, "end": 1441,
     "pattern": "switch type"},
