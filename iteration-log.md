...
- 合并提交点：3 子分支按 C→A→B 顺序并入父分支；main=收口 commit 后 push origin。根目录新增 4 份第 28 轮报告（A/B 各 1 份 + C 卡核验报告/清理报告各 1 份）；file-structure.zh.md 同步（mindmap 第 7~27 轮→第 7~28 轮 + 4 份报告登记，无重复行）。（A/B 卡具体目标以各卡 body 为准，收口时完善本节）
- 遗留问题（第 27 轮 17 项 → 更新）：① issue #1 OPEN 待真机验证；② ITER-15 决策门 4 问待用户确认；③ ITER-14 时间驱动（第 22 次核验健在，2026-11 前无动作）；④ 口径统一 32+114（32 日期复核 0 不符；**114 口径 :1163/:1174 → 第 28 轮发现 +11 新漂移（:1174/:1185，round-27 A 卡 cf6d36e 合入 TouchBarController +11 行所致），口径已更新 + ITEMS_REFERENCE :1709 同步**）；⑤ 内存修复真机冒烟 3 项挂账；⑥ currency 真机冒烟挂账；⑦ holidayCountdown 真机冒烟挂账；⑧ 隐藏机制真机冒烟挂账（第 27 轮 A/B 卡落地后覆盖再扩大）；⑨ add_files.py 已闭环；⑩ 第 19 轮观察 + 第 20 轮登记已闭环；⑪ 第 21 轮新登记 2 项挂账；⑫ 第 23 轮 A/B 卡新登记 2 项之一（失焦在途定位）已闭环（第 27 轮 B 卡）；⑬ 第 24 轮新登记：真机冒烟延续挂账 4 项 + 版本体系观察已收口关闭；⑭ 第 25 轮 A 卡新登记已闭环（第 26 轮 B 卡落盘）；⑮ 第 26 轮 A 卡新登记已闭环（第 27 轮 A 卡）；⑯ 第 26 轮 B 卡零新增；⑰ 第 26 轮 C 卡零新增 + 第 27 轮 C 卡新增发现 1 项（命名不一致）保持登记 + **本轮 C 卡新增发现 1 项（114 口径行号 +11 漂移，见子任务 C 记录）**；第 27 轮 B 卡新登记（GPS 灯观感真机冒烟）挂账；真机冒烟延续挂账不变（第 8/17~28 轮同口径）。
- 下轮方向：① 继续功能/优化迭代第 17 轮候选（A/B 卡落地后真机冒烟、TECHNICAL_DEBT 暂缓项前置条件跟踪（① VC 化全体系重写、② 注册表混合架构对账测试已落地 + 注册链 6 处文档化，前置条件已兑现）、真机冒烟多项挂账待用户 Touch Bar 真机确认）；② 待用户确认事项继续跟踪（issue #1 关闭 / ITER-15 使用场景 4 问）；③ ITER-14 时间驱动持续跟踪（2026-11 国办 2027 节假日通知核对）。（收口时完善）
