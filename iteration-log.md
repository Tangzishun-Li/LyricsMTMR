...
- 合并提交点：3 子分支按 C→A→B 顺序并入父分支；main=收口 commit 后 push origin。根目录新增 4 份第 27 轮报告：验证报告_第27轮_…（A）、验证报告/评估报告_第27轮_…（B）、核验报告_第27轮_维护机制健在与文档一致性.md + 清理报告_第27轮_round26遗留清理.md（C）；file-structure.zh.md 同步（mindmap 第 7~26 轮→第 7~27 轮 + 4 份报告登记，无重复行）。
- 遗留问题（第 26 轮 17 项 → 更新）：① issue #1 OPEN 待真机验证；② ITER-15 决策门 4 问待用户确认；③ ITER-14 时间驱动（第 21 次核验健在，2026-11 前无动作）；④ 口径统一 32+114（:1163/:1174 第 26 轮合并后第二轮复查零新漂移）；⑤ 内存修复真机冒烟 3 项挂账；⑥ currency 真机冒烟挂账；⑦ holidayCountdown 真机冒烟挂账；⑧ 隐藏机制真机冒烟挂账（第 26 轮 A 卡修复后测试侧全局隐藏态污染已闭环：两文件 setUp 复位）；⑨ add_files.py 已闭环；⑩ 第 19 轮观察 + 第 20 轮登记已闭环；⑪ 第 21 轮新登记 2 项挂账；⑫ 第 23 轮 A/B 卡新登记 2 项挂账；⑬ 第 24 轮新登记：真机冒烟延续挂账 4 项 + 版本体系观察已收口关闭；⑭ 第 25 轮 A 卡新登记已闭环（第 26 轮 B 卡落盘）；⑮ **第 26 轮 A 卡新登记（updateActiveApp 生产观察项）→ 本轮 A 卡承接中（r27/activeapp-hidden）**；⑯ 第 26 轮 B 卡零新增；⑰ 第 26 轮 C 卡零新增 + **本轮 C 卡新增发现 1 项（第 26 轮 C 卡报告命名前缀不一致，见子任务 C 记录）**；真机冒烟延续挂账不变（第 8/17~27 轮同口径）。
- 下轮方向：① **第 28 轮分解前触发全量回归**（隔代规则：第 26 轮收口 214 + 第 27 轮收口实证后触发，届时基线口径 214）；② 继续功能/优化迭代第 16 轮候选：A/B 卡落地后真机冒烟、TECHNICAL_DEBT 暂缓项前置条件跟踪（① VC 化全体系重写、② 注册表混合架构对账测试已落地 + 注册链 6 处文档化，前置条件已兑现）、真机冒烟多项挂账待用户 Touch Bar 真机确认；③ 待用户确认事项继续跟踪（issue #1 关闭 / ITER-15 使用场景 4 问）；④ ITER-14 时间驱动持续跟踪（2026-11 国办 2027 节假日通知核对）。
### 子任务记录
