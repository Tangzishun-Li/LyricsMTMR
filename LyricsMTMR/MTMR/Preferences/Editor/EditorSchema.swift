...
enum EditorSchema {
    ...
    private static func partMedia() -> [ItemSchema] {
        ...
        ItemSchema(type: "music", displayName: localized("音乐", "Music"), symbol: "music.note", properties: [
            ItemProperty(key: "refreshInterval", displayName: localized("刷新间隔", "Refresh"), type: .integer(placeholder: "5"), isRequired: false, note: "s",
                         description: localized("播放信息刷新频率", "How often to check now-playing info"),
                         section: localized("数据源", "Data"), defaultValue: 5),
            ItemProperty(key: "disableMarquee", displayName: localized("禁用跑马灯", "No Marquee"), type: .boolean, isRequired: false, note: nil,
                         description: localized("禁用文字滚动效果", "Disable the scrolling marquee effect"),
                         section: localized("显示", "Display"), defaultValue: false),
            ItemProperty(key: "align", displayName: localized("对齐", "Align"), type: .selection(["left", "center", "right"]), isRequired: false, note: nil),
        ]),
    ...
    private static func partInfo() -> [ItemSchema] {
        ...
        ItemSchema(type: "weather", displayName: localized("天气", "Wx"), symbol: "cloud.sun", properties: [
            ItemProperty(key: "api_key", displayName: localized("API Key", "API Key"), type: .text(placeholder: "OpenWeatherMap key"), isRequired: false, note: nil,
                         description: localized("OpenWeatherMap API 密钥", "OpenWeatherMap API key"),
                         section: localized("数据源", "Data")),
            ItemProperty(key: "apiSource", displayName: localized("数据源", "API"), type: .selection(["openweather", "china"]), isRequired: false, note: nil,
                         description: localized("天气数据来源", "Weather data provider"),
                         section: localized("数据源", "Data"), defaultValue: "openweather"),
            ItemProperty(key: "units", displayName: localized("单位", "Units"), type: .selection(["metric", "imperial"]), isRequired: false, note: nil,
                         description: localized("温度单位", "Temperature units"),
                         section: localized("数据源", "Data"), defaultValue: "metric"),
            ItemProperty(key: "icon_type", displayName: localized("图标类型", "Icon"), type: .selection(["text", "images"]), isRequired: false, note: nil,
                         description: localized("天气图标显示方式", "Weather icon display mode"),
                         section: localized("显示", "Display"), defaultValue: "text"),
            ItemProperty(key: "cities", displayName: localized("城市代码", "Cities"), type: .stringList(placeholder: "CN101010100"), isRequired: false, note: nil,
                         description: localized("中国天气城市代码（apiSource=china 时使用）", "China weather city codes (when apiSource=china)"),
                         section: localized("数据源", "Data")),
            ItemProperty(key: "showHumidity", displayName: localized("显示湿度", "Humidity"), type: .boolean, isRequired: false, note: nil,
                         description: localized("显示当前湿度", "Show current humidity"),
                         section: localized("显示", "Display"), defaultValue: false),
            ItemProperty(key: "showWind", displayName: localized("显示风速", "Wind"), type: .boolean, isRequired: false, note: nil,
                         description: localized("显示当前风速", "Show current wind speed"),
                         section: localized("显示", "Display"), defaultValue: false),
            ItemProperty(key: "refreshInterval", displayName: localized("刷新间隔", "Refresh"), type: .integer(placeholder: "1800"), isRequired: false, note: "s",
                         description: localized("天气数据刷新频率", "How often to fetch weather"),
                         section: localized("数据源", "Data"), defaultValue: 1800),
            ItemProperty(key: "align", displayName: localized("对齐", "Align"), type: .selection(["left", "center", "right"]), isRequired: false, note: nil),
        ]),
        ...
        ItemSchema(type: "stock", displayName: localized("股票", "Stock"), symbol: "chart.line.uptrend.xyaxis", properties: [
            ItemProperty(key: "stocks", displayName: localized("股票代码", "Symbols"), type: .stringList(placeholder: "AAPL, 0700.HK, 600519.SS"), isRequired: false, note: nil,
                         ...
                         section: localized("数据源", "Data")),
            ItemProperty(key: "apiSource", displayName: localized("数据源", "API"), type: .selection(["tencent", "eastmoney"]), isRequired: false, note: nil,
                         description: localized("行情数据来源", "Market data provider"),
                         section: localized("数据源", "Data"), defaultValue: "tencent"),
            ItemProperty(key: "displayMode", displayName: localized("显示模式", "Mode"), type: .selection(["compact", "expanded", "marquee"]), isRequired: false, note: nil,
                         description: localized("compact 仅价格，expanded 含涨跌幅，marquee 跑马灯", "compact: price only; expanded: with change %; marquee: scrolling")),
            ...
            ItemProperty(key: "chartMode", displayName: localized("图表模式", "Chart Mode"), type: .selection(["fenzhong"]), isRequired: false, note: nil,
                         description: localized("图表类型", "Chart type"),
                         section: localized("显示", "Display"), defaultValue: "fenzhong"),
            ItemProperty(key: "textWidth", displayName: localized("文字宽度", "Text W"), type: .integer(placeholder: "70"), isRequired: false, note: "pt",
                         description: localized("文字区域宽度", "Text area width"),
                         section: localized("显示", "Display"), defaultValue: 70),
    ...
    private static func partSpecial() -> [ItemSchema] {
        ...
        ItemSchema(type: "expandable", displayName: localized("展开", "Expand"), symbol: "chevron.down.square", properties: [
            ...
            ItemProperty(key: "align", displayName: localized("对齐", "Align"), type: .selection(["left", "center", "right"]), isRequired: false, note: nil),
            ItemProperty(key: "width", displayName: localized("宽度", "Width"), type: .integer(placeholder: "120"), isRequired: false, note: "pt"),
            ItemProperty(key: "closePosition", displayName: localized("关闭按钮位置", "Close Pos"), type: .selection(["left", "right"]), isRequired: false, note: nil,
                         description: localized("展开面板的关闭按钮位置", "Position of the close button in the expanded panel"),
                         defaultValue: "left"),
            ItemProperty(key: "cardWidthRatio", displayName: localized("卡片宽度比", "Card Ratio"), type: .slider(range: 0.1...1.0, step: 0.05, unit: ""), isRequired: false, note: nil,
                         description: localized("展开面板宽度占 Touch Bar 的比例", "Expanded panel width as fraction of Touch Bar width"),
                         defaultValue: 0.5),
        ]),
        ]
    }
