...
final class JSONBracketMatchingTextView: NSTextView {
    ...
    private func highlightMatchingBrackets() {
        ...
        // 如果是右括号，找匹配的左括号
        if let opening = bracketPairs.first(where: { $0.value == char })?.key {
...
final class LineNumberRulerView: NSRulerView {
    ...
    override func needsDisplay(forAccessoryQuickActionItemAtIndex accessoryQuickActionItemIndex: Int) -> Bool {
        return true
    }
}
